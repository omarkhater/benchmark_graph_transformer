...
def test_evaluate_node_level(
    ...
    direct = eval_mod._evaluate_node_level(
...
def test_evaluate_generic_accuracy(
    ...
    direct = eval_mod._evaluate_generic(
