...
def test_log_dataset_stats_computes_correct_stats(caplog):
...
def test_log_dataset_stats_mlflow_params(monkeypatch):
    ...
    assert logged_params["train_num_graphs"] == 3
    assert logged_params["train_avg_nodes"] == 2.33
    assert logged_params["train_min_nodes"] == 2
    assert logged_params["train_max_nodes"] == 3
    assert logged_params["train_avg_edges"] == 2
    assert logged_params["train_min_edges"] == 1
    assert logged_params["train_max_edges"] == 3
